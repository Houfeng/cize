...
const Server = new Class({
  ...
  config: function (options) {
    ...
    var tmpdir = process.env.TMPDIR || os.tmpdir();
    this.options.workspace = path.normalize(this.options.workspace || `${tmpdir}/${pkg.name}`);
   ...
   **/
  invoke: function (projectName, job, params, callback, startedCallback) {
    ...
    this.project(projectName).invoke(job, params, callback, startedCallback);
  },
